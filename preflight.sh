...
#   - file_guard.el (application-level write protection)
#   - read-only submounts in emacboros.sh (mount-level protection)
#   - chmod hardening in emacboros.sh (DAC-level, bypassed by root but adds friction)
# =============================================================================
